...
exports.updateCar = (id) => {
    let car = xmlObject.urlset.url.find((v) => (v.loc === 'https://www.starmotorsales.net/car/'+id));
    let today = new Date();
    ...
    if (car == undefined) {
        ...
        xmlObject.urlset[xmlObject.urlset.url.indexOf(car)].lastmod = lastmod;
    }
...
exports.removeCar = (id) => {
    ...
    xmlObject.urlset = xmlObject.urlset.url.filter((v) => (v !== car));
    xmlObject.urlset[1].lastmod = lastmod;
